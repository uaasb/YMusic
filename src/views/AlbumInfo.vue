<template>
    <div class="flex album-container">
        ...
        <div class="pl-5 flex flex-col justify-between py-1 flex-1">
            ...
            <div class="justify-self-stretch mt-5 gap-x-2 flex items-center">
                <button class="w-32 button items-center flex hover:text-brandColor">
                    <IconPark :icon="PlayOne" size="22" class="mr-2 " />
                    <span>播放全部</span>
                </button>
                <button class="w-32 button-outline items-center flex hover:text-brandColor">
                    <IconPark :icon="Like" size="18" class="mr-2" />
                    <span>收藏</span>
                </button>
